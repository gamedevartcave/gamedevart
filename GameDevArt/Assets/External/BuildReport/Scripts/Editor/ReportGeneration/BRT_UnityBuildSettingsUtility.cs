...
public static class UnityBuildSettingsUtility
{
	...
	public static void PopulateGeneralSettings(UnityBuildSettings settings)
	{
		...
		settings.StrippingLevelUsed = PlayerSettings.GetManagedStrippingLevel (BuildTargetGroup.Standalone).ToString();
	...
	public static void PopulateStandaloneSettings(UnityBuildSettings settings)
	{
		...
		settings.StandaloneDefaultScreenHeight = PlayerSettings.defaultScreenHeight;
			...
			//settings.StandaloneFullScreenByDefault = PlayerSettings.fullScreenMode;
#if !UNITY_5_2_AND_LESSER
...
#endif
			settings.WinDirect3D9FullscreenModeUsed = PlayerSettings.fullScreenMode.ToString ();
#if !UNITY_4
			settings.WinDirect3D11FullscreenModeUsed = PlayerSettings.fullScreenMode.ToString ();
#endif
		...
		settings.MacUseAppStoreValidation = PlayerSettings.useMacAppStoreValidation;
			settings.MacFullscreenModeUsed = PlayerSettings.fullScreenMode.ToString ();
	}
